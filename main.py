# -*- coding: utf-8 -*-
"""End_to_end_image_compression_stl10.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1pSQTc8dwZPiZ0E2dRquor60Pp8pifUUU
...
parser.add_argument('--image_size', type=int, default=96, help='path to images. Default=200')
...
def validation(epoch,model1,model2, test_loader):
  ...
  for i, (data, _) in enumerate(test_loader):
        ...
        test_loss += loss_function(final, residual_img, upscaled_image, com_img, data).data
...
def main():
    ...
    if opt.dataset.upper() == 'STL10':
        ...
        val_set = datasets.STL10(root='./data', split='test',download=True, transform=img_transform)
    
    train_loader = torch.utils.data.DataLoader(trainset, batch_size=16,
                                        shuffle=True, num_workers=2)
    val_loder = torch.utils.data.DataLoader(val_set, batch_size=16,shuffle=False, num_workers=2)
    ...
    for epoch in range(1, EPOCHS+1):
        ...
        train(epoch,model1,model2,train_loader)
        validation(epoch,model1,model2,val_loder)
